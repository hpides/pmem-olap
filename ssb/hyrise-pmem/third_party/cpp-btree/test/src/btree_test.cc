...
TEST(Btree, RangeCtorSanity) {
  ...
  using test_map =
      btree_map<int, int, std::less<int>, std::allocator<int>, 256>;
  using test_mset =
      btree_multiset<int, std::less<int>, std::allocator<int>, 256>;
  using test_mmap =
      btree_multimap<int, int, std::less<int>, std::allocator<int>, 256>;
